package com.example.selectpropertyassignment.expandable;
...
public class ExampleExpandableDataProvider extends AbstractExpandableDataProvider {
    ...
    public ExampleExpandableDataProvider() {
        final String groupItems = "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ";
        final String childItems = "abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc";
    ...
    public static final class ConcreteGroupData extends GroupData {
        ...
        @Override
        public void setColor(int colorPos) {
